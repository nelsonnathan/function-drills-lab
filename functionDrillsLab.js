...
//CODE HERE
function maximumChocolate(budget) {
  let frog = 3
  return Math.floor(budget / frog)
}

let totalFrogs = maximumChocolate(50)
...
function bathroom() {
  let rubberDuck = "squeaky"; //local to bathroom function
  function bathtub() {
    let sailorDuck = "nautical"; //local to bathtub function within bathroom function
  }
}

function pond() {
  let realDuck = "fluffy"; //local to pond function
}
